...
export function Dashboard() {
  ...
  // There is no backend yet in M1, so `projects` is always empty — this
  // branch exists so Dashboard renders a real project list the moment M2
  // starts populating the store, instead of needing a rewrite.
